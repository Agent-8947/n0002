...
const Hero = ({ localOverrides = {} }: any) => {
    ...
    return (
        <section className="min-h-[85vh] flex flex-col items-center justify-center text-center px-10 relative overflow-hidden">
            ...
            <h1 className="text-7xl md:text-9xl font-black uppercase tracking-tighter mb-8 relative z-10 leading-[0.8]">
              {data.title || 'ARCHITECTING\nDIGITAL DNA'}
            </h1>
            <p className="max-w-xl text-lg opacity-40 leading-relaxed font-medium relative z-10 uppercase tracking-widest text-xs">
